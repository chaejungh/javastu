...
@FunctionalInterface //추상함수가 1개 뿐인 인터페이스야 그러니 람다식 가능
interface Teattable{
    void a();
}
class TesttImp implements Teattable{
    @Override
    public void a() {
...
public class S30AnonyClassLambda {
    ...
    public static void main(String[] args) {
        new TesttImp();
        Teattable tt = ()->{
            // 익명 클래스가 귀찮아서 나온 언어(함수형 언어/프로토 타입 언어: 함수가 객체가 됨)
...
다음 코드에서 btn.addActionListener()에 전달된 것은 무엇인가?// addActionListener의 매개변수는 무엇인가
